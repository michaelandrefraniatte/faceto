    ...
    function setSearchList() {
        ...
        $.post(url, data).done(function (results) {
            ...
            links.forEach(function (link) {
                lines += '<tr><td>' + link.Channel + '</td></tr><br /><tr><td><a href=../?link=' + link.Link + '>' + link.Title + '</a></td></tr><br /><tr><td>Dernier commentaire le ' + localDay(link.DateCreated) + ' à ' + localTime(link.DateCreated) + '</td></tr><br /><tr><td><hr /></td></tr><br />';
                $("#links").html(lines);
            });
        });
    }